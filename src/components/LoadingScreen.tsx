...
export default function LoadingScreen() {
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center transition-colors duration-300 bg-gradient-to-br from-white via-slate-100 to-blue-50`} aria-busy="true" aria-live="polite" role="status">
      <div className="flex flex-col items-center gap-6">
        {/* Spinner Animation */}
        <span className="relative flex h-16 w-16">
          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-500 opacity-40"></span>
          <span className={`relative inline-flex rounded-full h-16 w-16 items-center justify-center bg-blue-500`}>
        ...
        {/* Loading Text */}
        <span className={`text-lg font-semibold tracking-wide text-blue-900`}>
